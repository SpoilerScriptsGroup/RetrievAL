...
#ifndef _M_IX86
unsigned char * __cdecl _mbsspnp(const unsigned char *string, const unsigned char *control)
{
...
#else
__declspec(naked) unsigned char * __cdecl _mbsspnp(const unsigned char *string, const unsigned char *control)
{
	__asm
	{
		#define string  (esp + 4)
