...
public TSSGCtrl_EnumReadSSG_distinction_ReplaceDefine

.code

align 16

TSSGCtrl_EnumReadSSG_distinction_ReplaceDefine proc near

	ReturnAddress                       equ 004E9FDFH
	_this                               equ <ebp + 8H>
	LineS                               equ <ebp - 38H>
...
TSSGCtrl_EnumReadSSG_distinction_ReplaceDefine endp
