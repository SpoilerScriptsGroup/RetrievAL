...
#ifndef _M_IX86
unsigned char * __cdecl _mbsncpy(unsigned char *string1, const unsigned char *string2, size_t count)
{
	if (count)
	{
...
#else
__declspec(naked) unsigned char * __cdecl _mbsncpy(unsigned char *string1, const unsigned char *string2, size_t count)
{
	__asm
	{
