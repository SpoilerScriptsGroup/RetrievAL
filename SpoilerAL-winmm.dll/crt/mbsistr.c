...
#ifndef _M_IX86
unsigned char * __cdecl _mbsistr(const unsigned char *haystack, const unsigned char *needle)
{
...
#else
__declspec(naked) unsigned char * __cdecl _mbsistr(const unsigned char *haystack, const unsigned char *needle)
{
	__asm
	{
