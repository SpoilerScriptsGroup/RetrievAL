...
typedef enum {
	...
	PRIORITY_STRDUP            = 127,   // strdup           OS_PUSH
	PRIORITY_WCSDUP            = 127,   // wcsdup           OS_PUSH
	...
	PRIORITY_MBSICMP           = 127,   // mbsicmp          OS_PUSH
	PRIORITY_STRNICMP          = 127,   // strnicmp         OS_PUSH
	PRIORITY_WCSNICMP          = 127,   // wcsnicmp         OS_PUSH
	PRIORITY_MBSNBICMP         = 127,   // mbsnbicmp        OS_PUSH
	PRIORITY_STRCPY            = 127,   // strcpy           OS_PUSH
	PRIORITY_WCSCPY            = 127,   // wcscpy           OS_PUSH
	PRIORITY_STRCAT            = 127,   // strcat           OS_PUSH
	PRIORITY_WCSCAT            = 127,   // wcscat           OS_PUSH
	PRIORITY_STRLCPY           = 127,   // strlcpy          OS_PUSH
	PRIORITY_WCSLCPY           = 127,   // wcslcpy          OS_PUSH
	PRIORITY_STRLCAT           = 127,   // strlcat          OS_PUSH
	PRIORITY_WCSLCAT           = 127,   // wcslcat          OS_PUSH
	PRIORITY_STRSTR            = 127,   // strstr           OS_PUSH
	PRIORITY_WCSSTR            = 127,   // wcsstr           OS_PUSH
	PRIORITY_MBSSTR            = 127,   // mbsstr           OS_PUSH
	PRIORITY_STRISTR           = 127,   // stristr          OS_PUSH
	PRIORITY_WCSISTR           = 127,   // wcsistr          OS_PUSH
	PRIORITY_MBSISTR           = 127,   // mbsistr          OS_PUSH
	PRIORITY_STRSPN            = 127,   // strspn           OS_PUSH
	PRIORITY_WCSSPN            = 127,   // wcsspn           OS_PUSH
	PRIORITY_MBSSPN            = 127,   // mbsspn           OS_PUSH
	PRIORITY_STRCSPN           = 127,   // strcspn          OS_PUSH
	PRIORITY_WCSCSPN           = 127,   // wcscspn          OS_PUSH
	PRIORITY_MBSCSPN           = 127,   // mbscspn          OS_PUSH
	PRIORITY_STRTOK            = 127,   // strtok           OS_PUSH
	PRIORITY_WCSTOK            = 127,   // wcstok           OS_PUSH
	PRIORITY_MBSTOK            = 127,   // mbstok           OS_PUSH
	PRIORITY_STRLWR            = 127,   // strlwr           OS_PUSH
	PRIORITY_WCSLWR            = 127,   // wcslwr           OS_PUSH
	PRIORITY_MBSLWR            = 127,   // mbslwr           OS_PUSH
	PRIORITY_STRUPR            = 127,   // strupr           OS_PUSH
	PRIORITY_WCSUPR            = 127,   // wcsupr           OS_PUSH
	PRIORITY_MBSUPR            = 127,   // mbsupr           OS_PUSH
#if ALLOCATE_SUPPORT
	...
	for (p = lpSrc, end = lpSrc + nSrcLength; p < end; bIsSeparatedLeft = bNextIsSeparatedLeft)
	{
		...
		*/
		...
		case 'l':
			...
			break;
		case 'm':
			// "mbscspn", "mbsicmp", "mbsistr", "mbslwr", "mbsnbicmp", "mbsnicmp", "mbsspn", "mbsstr", "mbstok", "mbsupr",
			...
			case BSWAP16('bs'):
				...
				case 'c':
					...
					bNextIsSeparatedLeft = TRUE;
					bCorrectTag = TRUE;
					APPEND_TAG_WITH_CONTINUE(TAG_MBSCSPN, 7, PRIORITY_MBSCSPN, OS_PUSH);
				case 'i':
					switch (*(uint16_t *)(p + 4))
					{
					case BSWAP16('cm'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_MBSICMP, 7, PRIORITY_MBSICMP, OS_PUSH);
					case BSWAP16('st'):
						if (p[6] != 'r')
							break;
						if (p[7] != '(' && !__intrinsic_isspace(p[7]))
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_MBSISTR, 7, PRIORITY_MBSISTR, OS_PUSH);
					}
					break;
				case 'l':
					...
					bNextIsSeparatedLeft = TRUE;
					bCorrectTag = TRUE;
					APPEND_TAG_WITH_CONTINUE(TAG_MBSLWR, 6, PRIORITY_MBSLWR, OS_PUSH);
				case 'n':
					...
					bNextIsSeparatedLeft = TRUE;
					bCorrectTag = TRUE;
					APPEND_TAG_WITH_CONTINUE(TAG_MBSNBICMP, 9, PRIORITY_MBSSTR, OS_PUSH);
				case 's':
					switch (*(uint16_t *)(p + 4))
					{
					case BSWAP16('pn'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_MBSSPN, 6, PRIORITY_MBSSPN, OS_PUSH);
					case BSWAP16('tr'):
						if (p[6] != '(' && !__intrinsic_isspace(p[6]))
							break;
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_MBSSTR, 6, PRIORITY_MBSSTR, OS_PUSH);
					}
					break;
				case 't':
					...
					bNextIsSeparatedLeft = TRUE;
					bCorrectTag = TRUE;
					APPEND_TAG_WITH_CONTINUE(TAG_MBSTOK, 6, PRIORITY_MBSTOK, OS_PUSH);
				case 'u':
					...
					bNextIsSeparatedLeft = TRUE;
					bCorrectTag = TRUE;
					APPEND_TAG_WITH_CONTINUE(TAG_MBSUPR, 6, PRIORITY_MBSUPR, OS_PUSH);
				}
				break;
			case BSWAP16('em'):
				switch (*(uint16_t *)(p + 3))
		...
		case 'r':
			...
			break;
		case 's':
			// "sar", "strcat", "strcmp", "strcpy", "strcspn", "strdup", "stricmp", "stristr", "strlcat", "strlcpy", "strlen::", "strlwr", "strncmp", "strnicmp", "strspn", "strstr", "strtok", "strupr"
			...
			case 't':
				...
				case 'c':
					...
					case BSWAP16('at'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_STRCAT, 6, PRIORITY_STRCAT, OS_PUSH);
					case BSWAP16('mp'):
						if (p[6] != '(' && !__intrinsic_isspace(p[6]))
							break;
						bNextIsSeparatedLeft = TRUE;
					...
					case BSWAP16('sp'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_STRCSPN, 7, PRIORITY_STRCSPN, OS_PUSH);
					}
					break;
				case 'd':
					...
					bNextIsSeparatedLeft = TRUE;
					bCorrectTag = TRUE;
					APPEND_TAG_WITH_CONTINUE(TAG_STRDUP, 6, PRIORITY_STRDUP, OS_PUSH);
				case 'i':
					switch (*(uint16_t *)(p + 4))
					{
					case BSWAP16('cm'):
				...
				case 'l':
					...
					case BSWAP16('ca'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_STRLCAT, 7, PRIORITY_STRLCAT, OS_PUSH);
					case BSWAP16('cp'):
						if (p[6] != 'y')
							break;
						if (p[7] != '(' && !__intrinsic_isspace(p[7]))
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_STRLCPY, 7, PRIORITY_STRLCPY, OS_PUSH);
					case BSWAP16('en'):
					...
					case BSWAP16('wr'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_STRLWR, 6, PRIORITY_STRLWR, OS_PUSH);
					}
					break;
				case 'n':
					switch (*(uint16_t *)(p + 4))
				...
				case 's':
					...
					case BSWAP16('pn'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_STRSPN, 6, PRIORITY_STRSPN, OS_PUSH);
					case BSWAP16('tr'):
						if (p[6] != '(' && !__intrinsic_isspace(p[6]))
							break;
						bNextIsSeparatedLeft = TRUE;
				...
				case 't':
					...
					bNextIsSeparatedLeft = TRUE;
					bCorrectTag = TRUE;
					APPEND_TAG_WITH_CONTINUE(TAG_STRTOK, 6, PRIORITY_STRTOK, OS_PUSH);
				case 'u':
					if (*(uint16_t *)(p + 4) != BSWAP16('pr'))
						break;
					if (p[6] != '(' && !__intrinsic_isspace(p[6]))
					...
					bNextIsSeparatedLeft = TRUE;
					bCorrectTag = TRUE;
					APPEND_TAG_WITH_CONTINUE(TAG_STRUPR, 6, PRIORITY_STRUPR, OS_PUSH);
				}
				break;
#if IMPLEMENTED
			case 'w':
		...
		case 'u':
			...
			break;
		case 'w':
			// "wcscat", "wcscmp", "wcscpy", "wcscspn", "wcsdup", "wcsicmp", "wcsistr", "wcslcat", "wcslcpy", "wcslen::", "wcslwr", "wcsncmp", "wcsnicmp", "wcsspn", "wcsstr", "wcstok", "while", "wcsupr"
			if (!bIsSeparatedLeft)
				break;
			switch (p[1])
			{
			case 'c':
				...
				case 'c':
					...
					case BSWAP16('at'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_WCSCAT, 6, PRIORITY_WCSCAT, OS_PUSH);
					case BSWAP16('mp'):
						if (p[6] != '(' && !__intrinsic_isspace(p[6]))
							break;
						bNextIsSeparatedLeft = TRUE;
					...
					case BSWAP16('sp'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_WCSCSPN, 7, PRIORITY_WCSCSPN, OS_PUSH);
					}
					break;
				case 'd':
					if (*(uint16_t *)(p + 4) != BSWAP16('up'))
					...
					bNextIsSeparatedLeft = TRUE;
					bCorrectTag = TRUE;
					APPEND_TAG_WITH_CONTINUE(TAG_WCSDUP, 6, PRIORITY_WCSDUP, OS_PUSH);
				case 'i':
					switch (*(uint16_t *)(p + 4))
					{
					case BSWAP16('cm'):
				...
				case 'l':
					...
					case BSWAP16('ca'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_WCSLCAT, 7, PRIORITY_WCSLCAT, OS_PUSH);
					case BSWAP16('cp'):
						if (p[6] != 'y')
							break;
						if (p[7] != '(' && !__intrinsic_isspace(p[7]))
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_WCSLCPY, 7, PRIORITY_WCSLCPY, OS_PUSH);
					case BSWAP16('en'):
						if (*(uint16_t *)(p + 6) != BSWAP16('::'))
							break;
						bNextIsSeparatedLeft = TRUE;
					...
					case BSWAP16('wr'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_WCSLWR, 6, PRIORITY_WCSLWR, OS_PUSH);
					}
					break;
				case 'n':
					switch (*(uint16_t *)(p + 4))
				...
				case 's':
					...
					case BSWAP16('pn'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_WCSSPN, 6, PRIORITY_WCSSPN, OS_PUSH);
					case BSWAP16('tr'):
						if (p[6] != '(' && !__intrinsic_isspace(p[6]))
							break;
						bNextIsSeparatedLeft = TRUE;
				...
				case 't':
					...
					bNextIsSeparatedLeft = TRUE;
					bCorrectTag = TRUE;
					APPEND_TAG_WITH_CONTINUE(TAG_WCSTOK, 6, PRIORITY_WCSTOK, OS_PUSH);
				case 'u':
					if (*(uint16_t *)(p + 4) != BSWAP16('pr'))
						break;
					if (p[6] != '(' && !__intrinsic_isspace(p[6]))
					...
					bNextIsSeparatedLeft = TRUE;
					bCorrectTag = TRUE;
					APPEND_TAG_WITH_CONTINUE(TAG_WCSUPR, 6, PRIORITY_WCSUPR, OS_PUSH);
				}
				break;
			case 'h':
...
//---------------------------------------------------------------------
static LPVOID __fastcall AppendStringBuffer(LPVOID **lplpStringBuffer, size_t *lpnNumberOfStringBuffer, size_t cbStringSize)
{
	...
	if (lpStringBuffer)
	{
		if (!(nNumberOfStringBuffer & 0x0F))
		{
			lpStringBuffer = (LPVOID *)HeapReAlloc(hHeap, 0, lpStringBuffer, (nNumberOfStringBuffer + 0x10) * sizeof(LPVOID));
			if (!lpStringBuffer)
				return NULL;
	...
	{
		lpStringBuffer = (LPVOID *)HeapAlloc(hHeap, 0, 0x10 * sizeof(LPVOID));
		if (!lpStringBuffer)
			return NULL;
		*lplpStringBuffer = lpStringBuffer;
	}
	lpString = HeapAlloc(hHeap, HEAP_ZERO_MEMORY, cbStringSize);
	if (!lpString)
		return FALSE;
	lpStringBuffer[nNumberOfStringBuffer] = lpString;
	*lpnNumberOfStringBuffer = nNumberOfStringBuffer + 1;
	return lpString;
}
//---------------------------------------------------------------------
		...
		case TAG_STRDUP_END:
			{
				...
				if (!(lpDest = AppendStringBuffer(&lpStringBuffer, &nNumberOfStringBuffer, nSize + 1)))
					goto STRDUP_PARSING_ERROR;
		...
		case TAG_WCSDUP_END:
			{
				...
				if (!(lpDest = AppendStringBuffer(&lpStringBuffer, &nNumberOfStringBuffer, nSize + sizeof(wchar_t))))
					goto WCSDUP_PARSING_ERROR;
				Status = MoveProcessMemory(NULL, lpDest, hSrcProcess, lpSrc, nSize);
				if (lpBuffer)
					HeapFree(hHeap, 0, lpBuffer);
		...
		case TAG_STRCPY_END:
			{
				...
				{
					if (!(lpDest = AppendStringBuffer(&lpStringBuffer, &nNumberOfStringBuffer, nSize)))
						goto STRCPY_FAILED;
					if (IsInteger)
					{
		...
		case TAG_STRLCPY_END:
			{
				...
				if (!hDestProcess && !lpDest)
				{
					if (!(lpDest = AppendStringBuffer(&lpStringBuffer, &nNumberOfStringBuffer, nCount)))
						goto STRLCPY_FAILED;
					if (IsInteger)
					{
						lpOperandTop->Quad = (size_t)lpDest;
				...
				if ((Status = nCount) && NT_SUCCESS(Status = MoveProcessMemory(hDestProcess, lpDest, hSrcProcess, lpSrc, nSize)))
				{
					LPSTR lpTerminator;
		...
		case TAG_WCSLCPY_END:
			{
				...
				if (!hDestProcess && !lpDest)
				{
					if (!(lpDest = AppendStringBuffer(&lpStringBuffer, &nNumberOfStringBuffer, nCount * sizeof(wchar_t))))
						goto WCSLCPY_FAILED;
					if (IsInteger)
					{
						lpOperandTop->Quad = (size_t)lpDest;
						...
						if (++numberOfArgs == 1)
						{
							...
							else
							{
								...
								else
								{
									...
									cbMultiByte = element2->Length - prefixLength - 1;
									cbUtf8 = (unsigned int)MultiByteToUtf8(CP_THREAD_ACP, 0, lpMultiByteStr, cbMultiByte, NULL, 0);
									if (!(lpBuffer1 = (LPSTR)AppendStringBuffer(&lpStringBuffer, &nNumberOfStringBuffer, cbUtf8 + 1)))
										goto FAILED7;
									MultiByteToUtf8(CP_THREAD_ACP, 0, lpMultiByteStr, cbMultiByte, lpBuffer1, cbUtf8);
									lpBuffer1[cbUtf8] = '\0';
								}
					...
					if (element1->Type & (OS_OPEN | OS_CLOSE | OS_DELIMITER))
					{
						...
						if (++numberOfArgs == 1)
						{
							...
							else
							{
								...
								cbMultiByte = element2->Length - prefixLength - 1;
								cchWideChar = (unsigned int)MultiByteToWideChar(CP_THREAD_ACP, 0, lpMultiByteStr, cbMultiByte, NULL, 0);
								if (!(lpBuffer1 = (LPWSTR)AppendStringBuffer(&lpStringBuffer, &nNumberOfStringBuffer, cchWideChar * sizeof(wchar_t) + sizeof(wchar_t))))
									goto FAILED7;
								MultiByteToWideChar(CP_THREAD_ACP, 0, lpMultiByteStr, cbMultiByte, lpBuffer1, cchWideChar);
								lpBuffer1[cchWideChar] = L'\0';
							}
...
#endif
						if (lpUtf8Str = (LPSTR)AppendStringBuffer(&lpStringBuffer, &nNumberOfStringBuffer, nAllocSize))
						{
#ifdef _WIN64
			...
			if ((lpNext = lpMarkup + 1) != lpEndOfMarkup)
			{
				...
				if (cchWideChar = MultiByteToWideChar(CP_THREAD_ACP, 0, lpMultiByteStr, -1, NULL, 0))
				{
					...
					if (!IsInteger)
						nAllocSize += ULL2DBL_LOST_MAX;
#endif
					if (!(lpWideCharStr = (LPWSTR)AppendStringBuffer(&lpStringBuffer, &nNumberOfStringBuffer, nAllocSize)))
						goto A2W_FAILED;
#ifdef _WIN64
				...
				if (cchWideChar = MultiByteToWideChar(CP_UTF8, 0, lpUtf8Str, -1, NULL, 0))
				{
					...
					if (cbMultiByte = WideCharToMultiByte(CP_THREAD_ACP, 0, lpWideCharStr, cchWideChar, NULL, 0, NULL, NULL))
					{
						...
						if (!IsInteger)
							nAllocSize += ULL2DBL_LOST_MAX;
#endif
						if (lpMultiByteStr = (LPSTR)AppendStringBuffer(&lpStringBuffer, &nNumberOfStringBuffer, nAllocSize))
						{
#ifdef _WIN64
