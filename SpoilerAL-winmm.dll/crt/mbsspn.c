...
#ifndef _M_IX86
size_t __cdecl _mbsspn(const unsigned char *string1, const unsigned char *string2)
{
...
#else
__declspec(naked) size_t __cdecl _mbsspn(const unsigned char *string1, const unsigned char *string2)
{
	__asm
	{
