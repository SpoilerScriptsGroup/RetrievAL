...
bcb6_std_vector *(__cdecl *TSSGAttributeSelector_MakeNowAttributeVec)(TSSGAttributeSelector *_this) = (LPVOID)0x004D584C;
void(__cdecl *TSSGAttributeSelector_AddElement)(TSSGAttributeSelector *_this, LPVOID element) = (LPVOID)0x004D3DB8;
bcb6_std_vector *(__cdecl *TSSGAttributeSelector_PushElement)(TSSGAttributeSelector *_this, LPVOID element) = (LPVOID)0x004D3CDC;
