...
size_t __fastcall _ui64tona(unsigned __int64 value, char *buffer, BOOL upper, unsigned int radix);
size_t __fastcall _ui64tonw(unsigned __int64 value, wchar_t *buffer, BOOL upper, unsigned int radix);
