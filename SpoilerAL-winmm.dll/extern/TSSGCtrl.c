...
void(__cdecl *TSSGCtrl_EnumReadSSG)(TSSGCtrl *_this, bcb6_std_vector_string *SSGFile, LPVOID ParentStack, LPVOID ADJElem, DWORD RepeatIndex, DWORD ParentRepeat) = (LPVOID)0x004E5090;
...
bcb6_std_vector_string *(__cdecl *TSSGCtrl_ReadSSRFile)(bcb6_std_vector_string *Result, TSSGCtrl *_this, bcb6_std_string *Code, bcb6_std_vector_DWORD *Indices) = (LPVOID)0x004FEAEC;
...
bcb6_std_vector_string *(__cdecl *TSSGCtrl_GetSSGDataFile)(TSSGCtrl *_this, struct _TSSGSubject *SSGS, bcb6_std_string FName, bcb6_std_string DefaultExt, bcb6_std_string *CurrentDir) = (LPVOID)0x004EDFB8;
