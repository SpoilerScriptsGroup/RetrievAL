...
#ifndef _MBCS
TCHAR * __cdecl _tcsrstr(const TCHAR *string1, const TCHAR *string2)
{
	size_t needlelen;
	...
	return _tmemrmem(string1, _tcslen(string1), string2, needlelen);
}
#else
unsigned char * __cdecl _mbsrstr(const unsigned char *string1, const unsigned char *string2)
{
