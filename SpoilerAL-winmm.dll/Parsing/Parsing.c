...
EXTERN_C int __cdecl _utf8icmp(const unsigned char *string1, const unsigned char *string2);
EXTERN_C unsigned char * __cdecl _utf8str(const unsigned char *string1, const unsigned char *string2);
EXTERN_C unsigned char * __cdecl _utf8istr(const unsigned char *string1, const unsigned char *string2);
EXTERN_C int __cdecl _utf8nicmp(const unsigned char *string1, const unsigned char *string2, size_t count);
EXTERN_C int __cdecl _utf8nbicmp(const unsigned char *string1, const unsigned char *string2, size_t count);

EXTERN_C int __cdecl GuidePrint(const char *format, ...);
EXTERN_C int __fastcall GuidePrintV(const char *format, va_list argptr);
...
/*
 ...
 127 printf dprintf                     OS_PUSH
     ...
     strcmp wcscmp
     strncmp wcsncmp
     stricmp wcsicmp utf8icmp
     strnicmp wcsnicmp utf8nicmp utf8nbicmp
     strcpy wcscpy
     strstr wcsstr utf8str
     stristr wcsistr utf8istr
#if ALLOCATE_SUPPORT
 127 realloc                            OS_PUSH
#endif
#if IMPLEMENTED
...
typedef enum {
	...
	TAG_UTF8ICMP_END     ,  //   4 )                OS_PUSH | OS_CLOSE | OS_PARENTHESIS
	TAG_STRNICMP_END     ,  //   4 )                OS_PUSH | OS_CLOSE | OS_PARENTHESIS
	TAG_WCSNICMP_END     ,  //   4 )                OS_PUSH | OS_CLOSE | OS_PARENTHESIS
	TAG_UTF8NICMP_END    ,  //   4 )                OS_PUSH | OS_CLOSE | OS_PARENTHESIS
	TAG_UTF8NBICMP_END   ,  //   4 )                OS_PUSH | OS_CLOSE | OS_PARENTHESIS
	...
	TAG_UTF8STR_END      ,  //   4 )                OS_PUSH | OS_CLOSE | OS_PARENTHESIS
	TAG_STRISTR_END      ,  //   4 )                OS_PUSH | OS_CLOSE | OS_PARENTHESIS
	TAG_WCSISTR_END      ,  //   4 )                OS_PUSH | OS_CLOSE | OS_PARENTHESIS
	TAG_UTF8ISTR_END     ,  //   4 )                OS_PUSH | OS_CLOSE | OS_PARENTHESIS
#if ALLOCATE_SUPPORT
...
typedef enum {
	...
	PRIORITY_MEMCMP            = 127,   // memcmp           OS_PUSH
	...
	PRIORITY_STRCMP            = 127,   // strcmp           OS_PUSH
	PRIORITY_WCSCMP            = 127,   // wcscmp           OS_PUSH
	PRIORITY_STRNCMP           = 127,   // strncmp          OS_PUSH
	PRIORITY_WCSNCMP           = 127,   // wcsncmp          OS_PUSH
	PRIORITY_STRICMP           = 127,   // stricmp          OS_PUSH
	PRIORITY_WCSICMP           = 127,   // wcsicmp          OS_PUSH
	PRIORITY_UTF8ICMP          = 127,   // utf8icmp         OS_PUSH
	PRIORITY_STRNICMP          = 127,   // strnicmp         OS_PUSH
	PRIORITY_WCSNICMP          = 127,   // wcsnicmp         OS_PUSH
	PRIORITY_UTF8NICMP         = 127,   // utf8nicmp        OS_PUSH
	PRIORITY_UTF8NBICMP        = 127,   // utf8nbicmp       OS_PUSH
	PRIORITY_STRCPY            = 127,   // strcpy           OS_PUSH
	PRIORITY_WCSCPY            = 127,   // wcscpy           OS_PUSH
	PRIORITY_STRSTR            = 127,   // strstr           OS_PUSH
	PRIORITY_WCSSTR            = 127,   // wcsstr           OS_PUSH
	PRIORITY_UTF8STR           = 127,   // utf8str          OS_PUSH
	PRIORITY_STRISTR           = 127,   // stristr          OS_PUSH
	PRIORITY_WCSISTR           = 127,   // wcsistr          OS_PUSH
	PRIORITY_UTF8ISTR          = 127,   // utf8istr         OS_PUSH
#if ALLOCATE_SUPPORT
...
static MARKUP * __stdcall Markup(IN LPSTR lpSrc, IN size_t nSrcLength, OUT size_t *lpnNumberOfMarkup)
{
		...
		*/
		...
		case 'm':
			...
			case BSWAP16('cm'):
				...
				bNextIsSeparatedLeft = TRUE;
				bCorrectTag = TRUE;
				APPEND_TAG_WITH_CONTINUE(TAG_MEMCMP, 6, PRIORITY_MEMCMP, OS_PUSH);
			case BSWAP16('mo'):
		...
		case 'r':
			...
			break;
		case 's':
			// "sar", "strcmp", "strcpy", "stricmp", "stristr", "strlen::", "strncmp", "strnicmp", "strstr"
			...
			case 't':
				...
				case 'c':
					...
					case BSWAP16('mp'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_STRCMP, 6, PRIORITY_STRCMP, OS_PUSH);
					case BSWAP16('py'):
						if (p[6] != '(' && !__intrinsic_isspace(p[6]))
							break;
						bNextIsSeparatedLeft = TRUE;
				...
				case 'i':
					...
					case BSWAP16('cm'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_STRICMP, 7, PRIORITY_STRICMP, OS_PUSH);
					case BSWAP16('st'):
						if (p[6] != 'r')
							break;
						if (p[7] != '(' && !__intrinsic_isspace(p[7]))
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_STRISTR, 7, PRIORITY_STRISTR, OS_PUSH);
					}
					break;
				case 'l':
				...
				case 'n':
					...
					case BSWAP16('cm'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_STRNCMP, 7, PRIORITY_STRNCMP, OS_PUSH);
					case BSWAP16('ic'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_STRNICMP, 8, PRIORITY_STRNICMP, OS_PUSH);
					}
					break;
				case 's':
					if (*(uint16_t *)(p + 4) != BSWAP16('tr'))
						break;
					if (p[6] != '(' && !__intrinsic_isspace(p[6]))
						break;
					bNextIsSeparatedLeft = TRUE;
					bCorrectTag = TRUE;
					APPEND_TAG_WITH_CONTINUE(TAG_STRSTR, 6, PRIORITY_STRSTR, OS_PUSH);
				}
				break;
#if IMPLEMENTED
			case 'w':
		...
		case 'u':
			...
			// "utf8str", "utf8icmp", "utf8istr", "utf8nbicmp", "utf8nicmp", "utof::"
			if (!bIsSeparatedLeft)
				break;
			switch (p[1])
			{
			...
			case 't':
				...
				case BSWAP16('f8'):
					...
					case BSWAP16('ic'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_UTF8ICMP, 8, PRIORITY_UTF8ICMP, OS_PUSH);
					case BSWAP16('is'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_UTF8ISTR, 8, PRIORITY_UTF8ISTR, OS_PUSH);
					case BSWAP16('nb'):
						if (*(uint32_t *)(p + 6) != BSWAP32('icmp'))
							break;
						if (p[10] != '(' && !__intrinsic_isspace(p[10]))
							break;
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_UTF8NBICMP, 10, PRIORITY_UTF8STR, OS_PUSH);
					case BSWAP16('ni'):
						if (*(uint16_t *)(p + 6) != BSWAP16('cm'))
							break;
						if (p[8] != 'p')
							break;
						if (p[9] != '(' && !__intrinsic_isspace(p[9]))
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_UTF8NICMP, 9, PRIORITY_UTF8STR, OS_PUSH);
					case BSWAP16('st'):
						if (p[6] != 'r')
							break;
						if (p[7] != '(' && !__intrinsic_isspace(p[7]))
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_UTF8STR, 7, PRIORITY_UTF8STR, OS_PUSH);
					}
					break;
				case BSWAP16('of'):
					if (*(uint16_t *)(p + 4) != BSWAP16('::'))
						break;
					bNextIsSeparatedLeft = TRUE;
			...
			break;
		case 'w':
			// "wcscmp", wcscpy", "wcsicmp", "wcsistr", "wcslen::", "wcsncmp", "wcsnicmp", wcsstr", "while"
			if (!bIsSeparatedLeft)
				break;
			switch (p[1])
			{
			case 'c':
				...
				case 'c':
					...
					case BSWAP16('mp'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_WCSCMP, 6, PRIORITY_WCSCMP, OS_PUSH);
					case BSWAP16('py'):
						if (p[6] != '(' && !__intrinsic_isspace(p[6]))
							break;
						bNextIsSeparatedLeft = TRUE;
				...
				case 'i':
					...
					case BSWAP16('cm'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_WCSICMP, 7, PRIORITY_WCSICMP, OS_PUSH);
					case BSWAP16('st'):
						if (p[6] != 'r')
							break;
						if (p[7] != '(' && !__intrinsic_isspace(p[7]))
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_WCSISTR, 7, PRIORITY_WCSISTR, OS_PUSH);
					}
					break;
				case 'l':
					if (*(uint32_t *)(p + 4) != BSWAP32('en::'))
				...
				case 'n':
					...
					case BSWAP16('cm'):
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_WCSNCMP, 7, PRIORITY_WCSNCMP, OS_PUSH);
					case BSWAP16('ic'):
						if (*(uint16_t *)(p + 6) != BSWAP16('mp'))
							break;
						if (p[8] != '(' && !__intrinsic_isspace(p[8]))
						...
						bNextIsSeparatedLeft = TRUE;
						bCorrectTag = TRUE;
						APPEND_TAG_WITH_CONTINUE(TAG_WCSNICMP, 8, PRIORITY_WCSNICMP, OS_PUSH);
					}
					break;
				case 's':
					if (*(uint16_t *)(p + 4) != BSWAP16('tr'))
					...
					bNextIsSeparatedLeft = TRUE;
					bCorrectTag = TRUE;
					APPEND_TAG_WITH_CONTINUE(TAG_WCSSTR, 6, PRIORITY_WCSSTR, OS_PUSH);
				}
				break;
			case 'h':
	...
	if (bCorrectTag)
	{
		...
		for (MARKUP *lpTag1 = lpTagArray; lpTag1 < lpEndOfTag; lpTag1++)
		{
			...
			case TAG_UTF8ICMP:
				// correct utf8icmp
				CORRECT_FUNCTION(TAG_UTF8ICMP_END, 2);
				break;
			case TAG_STRNICMP:
				// correct strnicmp
			...
			case TAG_UTF8NICMP:
				// correct utf8nicmp
				CORRECT_FUNCTION(TAG_UTF8NICMP_END, 3);
				break;
			case TAG_UTF8NBICMP:
				// correct utf8nbicmp
				CORRECT_FUNCTION(TAG_UTF8NBICMP_END, 3);
				break;
			case TAG_STRCPY:
				// correct strcpy
			...
			case TAG_UTF8STR:
				// correct utf8str
				CORRECT_FUNCTION(TAG_UTF8STR_END, 2);
				break;
			case TAG_STRISTR:
				// correct stristr
			...
			case TAG_UTF8ISTR:
				// correct utf8istr
				CORRECT_FUNCTION(TAG_UTF8ISTR_END, 2);
				break;
#if ALLOCATE_SUPPORT
			case TAG_REALLOC:
				// correct realloc
	...
	for (size_t i = 0; i < nNumberOfPostfix; i++)
	{
						...
						else if (numberOfArgs == 2)
						{
							...
							else
							{
								...
								else if (!(--prefixLength))
								{
									...
									cchWideChar = MultiByteToWideChar(CP_THREAD_ACP, 0, string, length, NULL, 0);
									if (lpBuffer2 = HeapAlloc(hHeap, 0, ((size_t)cchWideChar + 1) * sizeof(wchar_t)))
									{
										MultiByteToWideChar(CP_THREAD_ACP, 0, string, length, (LPWSTR)lpBuffer2, cchWideChar);
								...
								else
								{
									...
									cchUtf8 = MultiByteToUtf8(CP_THREAD_ACP, 0, string, length, NULL, 0);
									if (lpBuffer2 = HeapAlloc(hHeap, 0, cchUtf8 + 1))
									{
										MultiByteToUtf8(CP_THREAD_ACP, 0, string, length, (LPSTR)lpBuffer2, cchUtf8);
										((LPSTR)(lpAddress2 = lpBuffer2))[cchUtf8] = '\0';
									}
									else
									{
										if (lpBuffer1)
					...
					if (element1->Type & (OS_OPEN | OS_CLOSE | OS_DELIMITER))
					{
						...
						if (++numberOfArgs == 1)
						{
							...
							if (!CHECK_STRING_OPERAND(element2, &prefixLength))
							{
								...
								operand++;
								nSize1 = StringLengthA(hProcess1, lpAddress1) + 1;
							}
							else
							{
								size_t length;
						...
						else
						{
							...
							if (!CHECK_STRING_OPERAND(element2, &prefixLength))
							{
								...
								operand++;
								nSize2 = StringLengthA(hProcess2, lpAddress2) + 1;
							}
							else
							{
								size_t length;
								...
								{
									nSize2 = (unsigned int)MultiByteToUtf8(CP_THREAD_ACP, 0, string, length, NULL, 0);
									if (lpBuffer2 = (LPSTR)HeapAlloc(hHeap, 0, nSize2 + 1))
									{
										MultiByteToUtf8(CP_THREAD_ACP, 0, string, length, lpBuffer2, nSize2);
					...
					if (element1->Type & (OS_OPEN | OS_CLOSE | OS_DELIMITER))
					{
						...
						if (++numberOfArgs == 1)
						{
							...
							if (!CHECK_STRING_OPERAND(element2, &prefixLength))
							{
								...
								operand++;
								nSize1 = (StringLengthW(hProcess1, lpAddress1) + 1) * sizeof(wchar_t);
							}
							else
							{
								size_t length;
						...
						else
						{
							...
							if (!CHECK_STRING_OPERAND(element2, &prefixLength))
							{
								...
								operand++;
								nSize2 = (StringLengthW(hProcess2, lpAddress2) + 1) * sizeof(wchar_t);
							}
							else
							{
								size_t length;
								...
								{
									MultiByteToWideChar(CP_THREAD_ACP, 0, string, length, lpBuffer2, nSize2);
		...
		case TAG_STRICMP_END:
			{
					...
					if (element1->Type & (OS_OPEN | OS_CLOSE | OS_DELIMITER))
					{
						...
						if (++numberOfArgs == 1)
						{
							...
							else
							{
								...
								if (length && string[length - 1] == '"')
									length--;
								cUnterminated1 = *(lpEndOfString1 = string + length);
								*lpEndOfString1 = '\0';
							}
						}
						else
						{
							...
							else
							{
								...
								if (length && string[length - 1] == '"')
									length--;
								cUnterminated2 = *(lpEndOfString2 = (LPSTR)string + length);
								*lpEndOfString2 = '\0';
							}
							break;
						}
				...
				if (numberOfArgs < 2)
					goto STRICMP_PARSING_ERROR;
				iResult = _mbsicmp(lpBuffer1, lpBuffer2);
				if (lpBuffer2)
					HeapFree(hHeap, 0, lpBuffer2);
				else
					*lpEndOfString2 = cUnterminated2;
					...
					if (element1->Type & (OS_OPEN | OS_CLOSE | OS_DELIMITER))
					{
						...
						else
						{
							...
							else
							{
								...
								{
									MultiByteToWideChar(CP_THREAD_ACP, 0, string, length, lpBuffer2, nSize);
									nSize *= sizeof(wchar_t);
		...
		case TAG_UTF8ICMP_END:
			{
				...
				if (element1 - 1 < lpMarkupArray)
					goto PARSING_ERROR;
				if ((element1 - 1)->Tag != TAG_UTF8ICMP)
					goto PARSING_ERROR;
				...
				if (numberOfArgs < 2)
					goto UTF8ICMP_PARSING_ERROR;
				iResult = _utf8icmp(lpBuffer1, lpBuffer2);
				HeapFree(hHeap, 0, lpBuffer2);
				HeapFree(hHeap, 0, lpBuffer1);
				if (IsInteger)
				{
		...
		case TAG_STRNICMP_END:
			{
					...
					if (element1->Type & (OS_OPEN | OS_CLOSE | OS_DELIMITER))
					{
						...
						else if (numberOfArgs == 2)
						{
							...
							else
							{
								...
								if (length && string[length - 1] == '"')
									length--;
								cUnterminated2 = *(lpEndOfString2 = string + length);
								*lpEndOfString2 = '\0';
							}
						}
						else
				...
				if (numberOfArgs < 3)
					goto STRNICMP_PARSING_ERROR;
				iResult = _mbsnbicmp(lpBuffer1, lpBuffer2, nCount);
				if (lpBuffer2)
					HeapFree(hHeap, 0, lpBuffer2);
				else
					*lpEndOfString2 = cUnterminated2;
		...
		case TAG_UTF8NICMP_END:
			{
				...
				if (element1 - 1 < lpMarkupArray)
					goto PARSING_ERROR;
				if ((element1 - 1)->Tag != TAG_UTF8NICMP)
					goto PARSING_ERROR;
				lpBuffer2 = lpBuffer1 = NULL;
				operand = lpOperandTop;
				numberOfArgs = depth = 0;
				...
				if (numberOfArgs < 3)
					goto UTF8NICMP_PARSING_ERROR;
				iResult = _utf8nicmp(lpBuffer1, lpBuffer2, nCount);
				HeapFree(hHeap, 0, lpBuffer2);
				HeapFree(hHeap, 0, lpBuffer1);
				if (IsInteger)
				{
		...
		case TAG_UTF8NBICMP_END:
			{
				...
				if (element1 - 1 < lpMarkupArray)
					goto PARSING_ERROR;
				if ((element1 - 1)->Tag != TAG_UTF8NBICMP)
					goto PARSING_ERROR;
				lpBuffer2 = lpBuffer1 = NULL;
				operand = lpOperandTop;
				numberOfArgs = depth = 0;
				...
				if (numberOfArgs < 3)
					goto UTF8NBICMP_PARSING_ERROR;
				iResult = _utf8nbicmp(lpBuffer1, lpBuffer2, nCount);
				HeapFree(hHeap, 0, lpBuffer2);
				HeapFree(hHeap, 0, lpBuffer1);
				if (IsInteger)
				{
					...
					if (element1->Type & (OS_OPEN | OS_CLOSE | OS_DELIMITER))
					{
						...
						else
						{
							if (operand->Quad)
							{
								...
								if (IsInteger)
								{
									if (!WriteProcessMemory(hProc, lpAddress, &nLen, sizeof(nLen), NULL))
										goto WRITE_ERROR;
								}
								else
								{
									double dLen = (double)nLen;
									if (!WriteProcessMemory(hProc, lpAddress, &dLen, sizeof(dLen), NULL))
										goto WRITE_ERROR;
								}
							}
							break;
				...
				do
					if (element1->Type & (OS_OPEN | OS_CLOSE | OS_DELIMITER))
					{
						...
						else
						{
							...
							{
								HANDLE hProc;
								size_t nLen = nSize / sizeof(wchar_t) - 1;
								lpAddress = IsInteger ? (LPVOID)(uintptr_t)operand->Quad : (LPVOID)(uintptr_t)operand->Real;
		...
		case TAG_WCSSTR_END:
			{
				...
				if (numberOfArgs < 2)
					goto WCSSTR_PARSING_ERROR;
				if (lpResult = wcsstr(lpBuffer1, lpBuffer2))
		...
		case TAG_UTF8STR_END:
			{
				...
				if (numberOfArgs < 2)
					goto UTF8STR_PARSING_ERROR;
				if (lpResult = _utf8str(lpBuffer1, lpBuffer2))
					lpResult = (LPSTR)lpString1 + (lpResult - lpBuffer1);
				HeapFree(hHeap, 0, lpBuffer2);
				HeapFree(hHeap, 0, lpBuffer1);
				if (IsInteger)
		...
		case TAG_WCSISTR_END:
			{
				...
				if (numberOfArgs < 2)
					goto WCSISTR_PARSING_ERROR;
				if (lpResult = _wcsistr(lpBuffer1, lpBuffer2))
					lpResult = (LPWSTR)lpString1 + (lpResult - lpBuffer1);
				HeapFree(hHeap, 0, lpBuffer2);
				HeapFree(hHeap, 0, lpBuffer1);
				if (IsInteger)
		...
		case TAG_UTF8ISTR_END:
			{
				...
				if (element1 - 1 < lpMarkupArray)
					goto PARSING_ERROR;
				if ((element1 - 1)->Tag != TAG_UTF8ISTR)
					goto PARSING_ERROR;
				lpBuffer2 = lpBuffer1 = NULL;
				operand = lpOperandTop;
				numberOfArgs = depth = 0;
				...
				if (numberOfArgs < 2)
					goto UTF8ISTR_PARSING_ERROR;
				if (lpResult = _utf8istr(lpBuffer1, lpBuffer2))
					lpResult = (LPSTR)lpString1 + (lpResult - lpBuffer1);
				HeapFree(hHeap, 0, lpBuffer2);
				HeapFree(hHeap, 0, lpBuffer1);
				if (IsInteger)
		...
		case TAG_STRLEN:
			if ((lpNext = lpMarkup + 1) != lpMarkupArray + nNumberOfMarkup)
			{
				...
				if (lpNext->Tag != TAG_PARAM_LOCAL)
				{
					if (!hProcess && !(hProcess = TProcessCtrl_Open(&SSGCtrl->processCtrl, PROCESS_DESIRED_ACCESS)))
						goto FAILED7;
					lpOperandTop->Quad = StringLengthA(hProcess, IsInteger ? (LPCSTR)lpOperandTop->Quad : (LPCSTR)(size_t)lpOperandTop->Real);
				}
				else
				{
		...
		case TAG_WCSLEN:
			if ((lpNext = lpMarkup + 1) != lpMarkupArray + nNumberOfMarkup)
			{
				...
				if (lpNext->Tag != TAG_PARAM_LOCAL)
				{
					if (!hProcess && !(hProcess = TProcessCtrl_Open(&SSGCtrl->processCtrl, PROCESS_DESIRED_ACCESS)))
						goto FAILED7;
					lpOperandTop->Quad = StringLengthW(hProcess, IsInteger ? (LPCWSTR)lpOperandTop->Quad : (LPCWSTR)(size_t)lpOperandTop->Real);
				}
				else
				{
				...
				if (!lpOperandTop->High)
				{
					...
					for (size_t j = 0; j < nNumberOfProcessMemory; j++)
					{
						...
						if (lpProcessMemory[j].Protect)
						{
							...
							lpProcessMemory[j].Address = lpAddress = VirtualAllocEx(hProcess, NULL, allocSize, MEM_COMMIT, lpProcessMemory[j].Protect);
						}
						else
						{
							lpProcessMemory[j].Address = lpAddress = HeapAlloc(pHeap, HEAP_ZERO_MEMORY, allocSize);
						}
						break;
					}
				}
			...
			if ((lpNext = lpMarkup + 1) != lpMarkupArray + nNumberOfMarkup)
			{
				...
				if (cchWideChar = MultiByteToWideChar(CP_THREAD_ACP, 0, source, -1, NULL, 0))
				{
					...
					if (lpWideCharStr = (LPWSTR)HeapAlloc(hHeap, 0, (size_t)cchWideChar * sizeof(wchar_t)))
					{
						...
						if (cchMultiByte = WideCharToMultiByte(CP_UTF8, 0, lpWideCharStr, cchWideChar, NULL, 0, NULL, NULL))
						{
							size_t allocSize;
							LPSTR  buffer;
							...
							if (buffer = (LPSTR)HeapAlloc(hHeap, HEAP_ZERO_MEMORY, allocSize))
							{
								...
								*(size_t *)&buffer = ((size_t)buffer + ULL2DBL_LOST_MAX) & -(ULL2DBL_LOST_MAX + 1);
								...
								WideCharToMultiByte(CP_UTF8, 0, lpWideCharStr, cchWideChar, buffer, cchMultiByte, NULL, NULL);
							}
						}
...
#endif
								lpOperandTop->Quad = (size_t)buffer;
								WideCharToMultiByte(CP_THREAD_ACP, 0, lpWideCharStr, cchWideChar, buffer, cchMultiByte, NULL, NULL);
							}
						}
						HeapFree(hHeap, 0, lpWideCharStr);
					}
		...
		case TAG_W2A:
			if ((lpNext = lpMarkup + 1) != lpMarkupArray + nNumberOfMarkup)
			{
				...
				lpOperandTop->Quad = 0;
				if (cchMultiByte = WideCharToMultiByte(CP_THREAD_ACP, 0, source, -1, NULL, 0, NULL, NULL))
				{
					size_t allocSize;
					LPSTR  buffer;
...
#endif
						lpOperandTop->Quad = (size_t)buffer;
						WideCharToMultiByte(CP_THREAD_ACP, 0, source, -1, buffer, cchMultiByte, NULL, NULL);
					}
				}
				if (lpNext->Tag != TAG_PARAM_LOCAL)
		...
		case TAG_W2U:
			if ((lpNext = lpMarkup + 1) != lpMarkupArray + nNumberOfMarkup)
			{
				...
				lpOperandTop->Quad = 0;
				if (cchMultiByte = WideCharToMultiByte(CP_UTF8, 0, source, -1, NULL, 0, NULL, NULL))
				{
					size_t allocSize;
					LPSTR  buffer;
...
#endif
						lpOperandTop->Quad = (size_t)buffer;
						WideCharToMultiByte(CP_UTF8, 0, source, -1, buffer, cchMultiByte, NULL, NULL);
					}
				}
				if (lpNext->Tag != TAG_PARAM_LOCAL)
					HeapFree(hHeap, 0, (LPWSTR)source);
		...
		case TAG_NOT_OPERATOR:
			{
				...
				case TAG_ADDRESS_OF:
					if (!element)
						break;
#if !defined(__BORLANDC__)
					operand.Quad = element->Node && (i + 2 == nNumberOfPostfix || lpPostfix[i + 2]->Tag == TAG_RETURN)
