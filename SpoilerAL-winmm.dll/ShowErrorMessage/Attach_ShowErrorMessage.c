...
EXTERN_C void __cdecl Attach_ShowErrorMessage()
{
	...
	*(LPDWORD)0x004A6FF4 = BSWAP32(0x58906A00);
	*(LPDWORD)0x004A6FF8 = BSWAP32(0xFF742410);
	*(LPDWORD)0x004A6FFC = BSWAP32(0xFF742410);
	*(LPDWORD)0x004A7000 = BSWAP32(0xFF742410);
	*(LPDWORD)0x004A7004 = BSWAP32(0xFF742410);
	*(LPDWORD)0x004A7008 = BSWAP32(0x669050E9);
	*(LPDWORD)0x004A700C = 0x00600E0C - (0x004A700C + sizeof(DWORD));

	// TProcessCtrl::OneWrite
	// forwarding to WriteProcessMemory
	*(LPDWORD)0x004A760C = BSWAP32(0x58906A00);
	*(LPDWORD)0x004A7610 = BSWAP32(0xFF742410);
	*(LPDWORD)0x004A7614 = BSWAP32(0xFF742410);
	*(LPDWORD)0x004A7618 = BSWAP32(0xFF742410);
	*(LPDWORD)0x004A761C = BSWAP32(0xFF742410);
	*(LPDWORD)0x004A7620 = BSWAP32(0x669050E9);
	*(LPDWORD)0x004A7624 = 0x00600EA2 - (0x004A7624 + sizeof(DWORD));
