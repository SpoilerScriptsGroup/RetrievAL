...
CopyUp:
        ...
        test    __isa_enabled, __ISA_ENABLED_SSE2
        jnz     XmmCopySmallTest
        jmp     Dword_align

CopyUpLargeMov:
        test    __favor, 1 shl __FAVOR_ENFSTRG  ; check if Enhanced Fast Strings is supported
        jz      CopyUpSSE2Check                 ; if not, check for SSE2 support
        rep     movsb
...
CopyUpSSE2Check:
        ...
        test    __isa_enabled, __ISA_ENABLED_SSE2
        jnz     XmmCopy ; yes, go SSE2 copy (params already set)
AtomChk:
        ; Is Atom supported?
        test   __favor, 1 shl __FAVOR_ATOM
        jz     Dword_align ; no,jump
