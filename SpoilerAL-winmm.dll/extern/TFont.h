...
EXTERN_C void __fastcall TFont_SetColor(TFont *this, COLORREF Color);
...
EXTERN_C TFontStyles __fastcall TFont_GetStyle(TFont *this);
...
EXTERN_C void __fastcall TFont_SetPitch(TFont *this, TFontPitch Pitch);
