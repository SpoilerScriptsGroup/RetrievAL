...
public TSSGCtrl_EnumReadSSG_involve_ReplaceDefine

.code

align 16

TSSGCtrl_EnumReadSSG_involve_ReplaceDefine proc near

	ReturnAddress                       equ 004E84DBH
	_this                               equ <ebp + 8H>
	LineS                               equ <ebp - 38H>
...
TSSGCtrl_EnumReadSSG_involve_ReplaceDefine endp
