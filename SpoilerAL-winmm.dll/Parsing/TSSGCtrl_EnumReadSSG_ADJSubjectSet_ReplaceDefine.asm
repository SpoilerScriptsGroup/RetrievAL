...
public TSSGCtrl_EnumReadSSG_ADJSubjectSet_ReplaceDefine

.code

align 16

TSSGCtrl_EnumReadSSG_ADJSubjectSet_ReplaceDefine proc near

	ReturnAddress                       equ 004EA5EFH
	_this                               equ <ebp + 8H>
	LineS                               equ <ebp - 38H>
...
TSSGCtrl_EnumReadSSG_ADJSubjectSet_ReplaceDefine endp
